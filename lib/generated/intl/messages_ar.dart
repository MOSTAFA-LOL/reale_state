...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    "login_title": MessageLookupByLibrary.simpleMessage(
      "سجّل الدخول إلى RealEstate باستخدام جيميل",
    ),
    "login_title2": MessageLookupByLibrary.simpleMessage(
      "من فضلك ادخل البريد الالكتروني ",
    ),
    "make_sure": MessageLookupByLibrary.simpleMessage("انشاء حساب"),
    "ontap": MessageLookupByLibrary.simpleMessage(" انشاء"),
    "register": MessageLookupByLibrary.simpleMessage("تسجيل دخول"),
    "search": MessageLookupByLibrary.simpleMessage("نتاتج بحث"),
